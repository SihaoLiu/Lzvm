...
pub struct CudaAllocatorStats {
    ...
    pub cuda_copy_d2h_second_hot_bytes: usize,
    pub cuda_copy_d2h_second_hot_count: usize,
    pub cuda_copy_d2h_second_hot_wait_ns: usize,
    pub cuda_direct_copy_d2h_calls: usize,
    pub cuda_direct_copy_d2h_bytes: usize,
    pub cuda_direct_copy_d2h_wait_ns: usize,
    pub cuda_direct_copy_d2h_max_wait_ns: usize,
    pub cuda_direct_copy_d2h_hot_bytes: usize,
    pub cuda_direct_copy_d2h_hot_count: usize,
    pub cuda_direct_copy_d2h_hot_wait_ns: usize,
