...
fn guest_pc_trace_parallel_lower_job_queue_capacity_is_bounded_and_configurable() {
    ...
    assert_eq!(guest_pc_trace_parallel_lower_job_queue_capacity(0), 16);
    assert_eq!(guest_pc_trace_parallel_lower_job_queue_capacity(2), 16);
    assert_eq!(guest_pc_trace_parallel_lower_job_queue_capacity(8), 16);
...
fn large_runtime_auto_lower_uses_bounded_workers() {
    ...
    assert_eq!(
        guest_pc_trace_auto_parallel_lower_worker_count_for_available(1),
        2
    );
    assert_eq!(
        guest_pc_trace_auto_parallel_lower_worker_count_for_available(2),
        2
    );
    assert_eq!(
        guest_pc_trace_auto_parallel_lower_worker_count_for_available(3),
        3
    );
    assert_eq!(
        guest_pc_trace_auto_parallel_lower_worker_count_for_available(4),
        3
    );
