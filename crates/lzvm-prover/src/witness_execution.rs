...
pub struct ProveWitnessGuestPcTraceTiming {
    ...
    guest_segment_commit_cuda_memory_sample_duration: Duration,
    guest_segment_commit_cuda_memory_sample_count: usize,
    ...
    guest_trace_external_op_row_duration: Duration,
    guest_trace_copy_row_duration: Duration,
    guest_trace_report_lowering_duration: Duration,
    guest_trace_report_row_validation_duration: Duration,
    guest_trace_report_row_validation_timer_bookkeeping_duration: Duration,
    ...
    guest_trace_copy_source_memory_read_duration: Duration,
    guest_trace_copy_source_indirect_read_duration: Duration,
    ...
    guest_trace_runner_report_buffer_capacity: usize,
    guest_trace_runner_report_buffer_max_capacity: usize,
    guest_trace_runner_report_buffer_excess_capacity: usize,
    ...
    guest_trace_runner_report_buffer_capacity_bytes: usize,
    guest_trace_runner_report_buffer_excess_bytes: usize,
    ...
    guest_trace_copy_memory_source_row_count: usize,
    guest_trace_copy_indirect_memory_row_count: usize,
    guest_trace_copy_register_store_row_count: usize,
    guest_trace_copy_memory_store_row_count: usize,
    guest_trace_copy_no_store_row_count: usize,
    guest_trace_copy_no_memory_row_count: usize,
...
impl ProveWitnessGuestPcTraceTiming {
    fn new(
        ...
        Self {
            ...
            guest_segment_commit_cuda_memory_sample_duration: run_timing
                .segment_commit_worker_timing
                .memory_timing
                .cuda_memory_sample_duration,
            guest_segment_commit_cuda_memory_sample_count: run_timing
                .segment_commit_worker_timing
                .memory_timing
                .cuda_memory_sample_count,
            ...
            guest_trace_runner_timer_bookkeeping_duration: stream_timing
                .runner_timer_bookkeeping_duration(),
            ...
            guest_trace_external_op_row_duration: stream_timing.trace_external_op_row_duration(),
            guest_trace_copy_row_duration: stream_timing.trace_copy_row_duration(),
            ...
            guest_trace_report_row_validation_timer_bookkeeping_duration: stream_timing
                .trace_report_row_validation_timer_bookkeeping_duration(),
            guest_trace_report_memory_columns_duration: stream_timing
            ...
            guest_trace_copy_source_memory_read_duration: stream_timing
                .trace_copy_source_memory_read_duration(),
            guest_trace_copy_source_indirect_read_duration: stream_timing
                .trace_copy_source_indirect_read_duration(),
            ...
            guest_trace_copy_source_memory_read_count: stream_timing
                .trace_copy_source_memory_read_count(),
            ...
            guest_trace_parallel_lower_snapshot_replay_duration: stream_timing
            ...
            guest_trace_parallel_lower_result_send_wait_duration: stream_timing
            ...
            guest_trace_runner_report_buffer_capacity: stream_timing
                .trace_runner_report_buffer_capacity(),
            guest_trace_runner_report_buffer_max_capacity: stream_timing
                .trace_runner_report_buffer_max_capacity(),
            guest_trace_runner_report_buffer_excess_capacity: stream_timing
            ...
            guest_trace_runner_report_buffer_capacity_bytes: stream_timing
                .trace_runner_report_buffer_capacity_bytes(),
            guest_trace_runner_report_buffer_excess_bytes: stream_timing
            ...
            guest_trace_copy_memory_source_row_count: stream_timing
                .trace_copy_memory_source_row_count(),
            guest_trace_copy_indirect_memory_row_count: stream_timing
                .trace_copy_indirect_memory_row_count(),
            guest_trace_copy_register_store_row_count: stream_timing
                .trace_copy_register_store_row_count(),
            guest_trace_copy_memory_store_row_count: stream_timing
                .trace_copy_memory_store_row_count(),
            guest_trace_copy_no_store_row_count: stream_timing.trace_copy_no_store_row_count(),
            guest_trace_copy_no_memory_row_count: stream_timing.trace_copy_no_memory_row_count(),
    ...
    fn replace_segment_commit_memory_timing(
        ...
        self.guest_segment_commit_cuda_memory_sample_duration =
            memory_timing.cuda_memory_sample_duration;
        self.guest_segment_commit_cuda_memory_sample_count = memory_timing.cuda_memory_sample_count;
    ...
    pub fn guest_segment_commit_cuda_memory_sample_duration(&self) -> Duration {
        self.guest_segment_commit_cuda_memory_sample_duration
    }

    pub fn guest_segment_commit_cuda_memory_sample_count(&self) -> usize {
        self.guest_segment_commit_cuda_memory_sample_count
    }
    ...
    pub fn guest_trace_runner_timer_bookkeeping_duration(&self) -> Duration {
        self.guest_trace_runner_timer_bookkeeping_duration
    }
    ...
    pub fn guest_trace_external_op_row_duration(&self) -> Duration {
        self.guest_trace_external_op_row_duration
    }

    pub fn guest_trace_copy_row_duration(&self) -> Duration {
        self.guest_trace_copy_row_duration
    }
    ...
    pub fn guest_trace_report_row_validation_timer_bookkeeping_duration(&self) -> Duration {
        self.guest_trace_report_row_validation_timer_bookkeeping_duration
    }

    pub fn guest_trace_report_memory_columns_duration(&self) -> Duration {
        self.guest_trace_report_memory_columns_duration
    }
    ...
    pub fn guest_trace_copy_source_memory_read_duration(&self) -> Duration {
        self.guest_trace_copy_source_memory_read_duration
    }

    pub fn guest_trace_copy_source_indirect_read_duration(&self) -> Duration {
        self.guest_trace_copy_source_indirect_read_duration
    }
    ...
    pub fn guest_trace_copy_source_memory_read_count(&self) -> usize {
        self.guest_trace_copy_source_memory_read_count
    }

    pub fn guest_trace_copy_source_indirect_read_count(&self) -> usize {
        self.guest_trace_copy_source_indirect_read_count
    }
    ...
    pub fn guest_trace_parallel_lower_snapshot_replay_duration(&self) -> Duration {
        self.guest_trace_parallel_lower_snapshot_replay_duration
    }
    ...
    pub fn guest_trace_parallel_lower_result_send_wait_duration(&self) -> Duration {
        self.guest_trace_parallel_lower_result_send_wait_duration
    }
    ...
    pub fn guest_trace_parallel_lower_dispatch_blocked_count(&self) -> usize {
        self.guest_trace_parallel_lower_dispatch_blocked_count
    }
    ...
    pub fn guest_trace_runner_report_buffer_capacity(&self) -> usize {
        self.guest_trace_runner_report_buffer_capacity
    }

    pub fn guest_trace_runner_report_buffer_max_capacity(&self) -> usize {
        self.guest_trace_runner_report_buffer_max_capacity
    }

    pub fn guest_trace_runner_report_buffer_excess_capacity(&self) -> usize {
        self.guest_trace_runner_report_buffer_excess_capacity
    }
    ...
    pub fn guest_trace_runner_report_buffer_capacity_bytes(&self) -> usize {
        self.guest_trace_runner_report_buffer_capacity_bytes
    }

    pub fn guest_trace_runner_report_buffer_excess_bytes(&self) -> usize {
        self.guest_trace_runner_report_buffer_excess_bytes
    }
    ...
    pub fn guest_trace_descriptor_high32_field_counts(
        &self,
...
impl ProveWitnessTraceTimingAccumulator {
    ...
    #[cfg_attr(not(feature = "cuda"), allow(dead_code))]
    fn add_descriptor_buffer_retention(
        &mut self,
        retained_byte_len: usize,
        retained: bool,
        limit_byte_count: usize,
    ) {
...
impl WitnessStageSourceDeviceCache {
    ...
    fn upload_from_trace_or_preloaded_if_empty(
        ...
        let upload_config = trace_cuda_run_config
            .map(|config| config.stage_source_upload)
            .unwrap_or_else(WitnessStageSourceUploadConfig::from_env);
    ...
    fn retained_guest_pc_device_descriptor_buffer(
        ...
        let retention_limit = retained_descriptor_buffer_limit();
...
#[cfg(feature = "cuda")]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
struct WitnessTraceCudaRunConfig {
    stage_source_upload: WitnessStageSourceUploadConfig,
    stage_source_retention: bool,
    stage_source_retention_debug: bool,
...
impl WitnessTraceCudaRunConfig {
    fn from_input(input_byte_count: usize) -> Self {
        ...
        Self {
            stage_source_upload: WitnessStageSourceUploadConfig::from_env(),
            stage_source_retention,
            stage_source_retention_debug: stage_source_retention
                && debug_fri_stage_source_devices(),
            descriptor_buffer_retention: guest_pc_descriptor_buffer_retention_enabled(
                input_byte_count,
            ),
        }
    }
...
#[cfg(feature = "cuda")]
fn selected_trace_cuda_run_config(
    cached_trace_cuda_run_config: Option<WitnessTraceCudaRunConfig>,
    input_byte_count: usize,
    ...
    loop {
        if collect_segment_commit_memory_timing {
            ...
            segment_commit_memory_timing
                .observe_attempt_start_with_duration(sample, sample_started.elapsed());
        }
        ...
        if collect_segment_commit_memory_timing {
            ...
            let sample = sample_guest_pc_segment_commit_cuda_memory();
            segment_commit_memory_timing
                .observe_attempt_end_with_duration(sample, sample_started.elapsed());
        }
        match result {
            Ok(outputs) => {
...
fn guest_pc_segment_commitment_trace(
    ...
    if has_external_device_source_material && traceless_commitment_input {
        return Ok(None);
    }
    segment_output
        .into_trace()
...
fn guest_pc_trace_traceless_commitment_input_selected() -> bool {
    #[cfg(feature = "cuda")]
    {
        guest_pc_trace_less_commitment_input_enabled()
    }
    #[cfg(not(feature = "cuda"))]
    {
        false
...
impl GuestPcTraceSegmentCommitWorkerState {
    ...
    fn new(traceless_commitment_input: bool, cross_segment_root_materialization: bool) -> Self {
        Self::from_parts(
            ...
            WitnessTraceCudaRunConfig {
                stage_source_upload: WitnessStageSourceUploadConfig::from_env(),
                stage_source_retention: false,
                stage_source_retention_debug: false,
    ...
    fn from_parts(
        traceless_commitment_input: bool,
        cross_segment_root_materialization: bool,
        #[cfg(feature = "cuda")] trace_cuda_run_config: WitnessTraceCudaRunConfig,
    ) -> Self {
        Self {
...
impl GuestPcTraceSegmentCommitMode {
    fn from_input(
        ...
        #[cfg(feature = "cuda")]
        let trace_cuda_run_config = WitnessTraceCudaRunConfig::from_input(input_byte_count);
        Self {
            worker_count,
...
impl<'scope, 'env> GuestPcTraceSegmentCommitWorkerPool<'scope, 'env> {
    ...
    fn submit_segment(
        ...
        #[cfg(feature = "cuda")]
        let trace_cuda_run_config = self.worker_state.trace_cuda_run_config;
...
struct GuestPcTraceSegmentCommitMemoryTiming {
    ...
    cuda_memory_sample_duration: Duration,
    cuda_memory_sample_count: usize,
...
impl GuestPcTraceSegmentCommitMemoryTiming {
    fn observe_attempt_start_with_duration(
        &mut self,
        ...
        self.observe_sample_with_duration(sample, duration);
    }

    fn observe_attempt_end_with_duration(
        &mut self,
        sample: GuestPcTraceSegmentCommitCudaMemorySample,
        duration: Duration,
    ) {
    ...
    fn observe_sample_with_duration(
        &mut self,
        sample: GuestPcTraceSegmentCommitCudaMemorySample,
        duration: Duration,
    ) {
        self.cuda_memory_sample_count += 1;
        self.cuda_memory_sample_duration += duration;
...
fn run_prove_witness_commitments_from_trace_pending_inner(
    ...
    let cached_trace_cuda_run_config = observers.trace_cuda_run_config;
...
mod tests {
    ...
    fn guest_pc_segment_commit_mode_caches_stage_source_retention() {
        ...
        let debug_env = TestEnvVarUnlockedGuard::new("LZVM_CUDA_FRI_STAGE_SOURCE_DEBUG");
        env.unset();
        debug_env.unset();
        ...
        assert!(default_mode.trace_cuda_run_config.stage_source_retention);
        assert_eq!(
            selected_trace_cuda_run_config(Some(default_mode.trace_cuda_run_config), 1024),
        ...
        assert!(selected_trace_cuda_run_config(None, 1024).stage_source_retention);
        assert!(!selected_trace_cuda_run_config(None, 1024).stage_source_retention_debug);
    }
    ...
    fn guest_pc_segment_commit_mode_caches_stage_source_upload_config() {
        ...
        assert!(enabled_upload_config.sparse_trace_source);
        assert_eq!(enabled_upload_config.sparse_trace_source_max_percent, 17);
        assert!(enabled_upload_config.debug_sparse_trace_source);
        ...
        debug_env.set("0");
        assert_eq!(
            selected_trace_cuda_run_config(Some(enabled_config), 1024),
            enabled_config
        );
        let current_config = selected_trace_cuda_run_config(None, 1024).stage_source_upload;
    ...
    fn guest_pc_segment_commit_mode_caches_descriptor_buffer_retention() {
        ...
        assert_eq!(
            selected_trace_cuda_run_config(Some(small_input_mode.trace_cuda_run_config), 1024),
    ...
    fn segment_commit_memory_timing_tracks_retry_attempt_headroom() {
        ...
        timing.observe_attempt_start_with_duration(
            GuestPcTraceSegmentCommitCudaMemorySample::default(),
            Duration::ZERO,
        );
        timing.observe_attempt_end_with_duration(
            GuestPcTraceSegmentCommitCudaMemorySample::default(),
            Duration::ZERO,
        );
        timing.observe_attempt_start_with_duration(
        ...
        assert_eq!(timing.cuda_memory_sample_count, 8);
        assert_eq!(timing.cuda_memory_sample_duration, Duration::ZERO);
    ...
    fn segment_commit_memory_timing_keeps_zero_initial_headroom() {
        ...
        assert_eq!(timing.cuda_memory_sample_count, 2);
        assert_eq!(timing.cuda_memory_sample_duration, Duration::ZERO);
    ...
    #[test]
    fn segment_commit_memory_timing_tracks_sample_duration() {
        let mut timing = GuestPcTraceSegmentCommitMemoryTiming::default();
        ...
        assert_eq!(timing.cuda_memory_sample_count, 2);
        assert_eq!(timing.cuda_memory_sample_duration, Duration::from_nanos(12));
        assert_eq!(timing.cuda_memory_initial_free_byte_count, 700);
        assert_eq!(timing.cuda_memory_effective_free_byte_count, 600);
    }
