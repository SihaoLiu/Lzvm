...
fn retained_cache_defaults_prioritize_descriptor_reuse() {
    ...
    assert!(
        values_source.contains(
            "const DEFAULT_RETAINED_DESCRIPTOR_BUFFER_BYTES: usize = 20_000_000_000"
        ) && values_source.contains(
            "const MAX_DEFAULT_RETAINED_DESCRIPTOR_BUFFER_BYTES: usize =\n    DEFAULT_RETAINED_DESCRIPTOR_BUFFER_BYTES"
        ),
        "default descriptor-buffer retention should use the measured 20GB cap for strict opening reuse"
    );
    assert!(
        values_source.contains("RETAINED_COMBINED_DEVICE_CACHE_RESERVE_BYTES")
...
fn guest_pc_trace_stream_reports_runner_lowerer_and_queue_wait_timing() {
    ...
    for field in [
        ...
        "guest_trace_runner_timer_bookkeeping_duration",
...
fn guest_pc_trace_lower_reports_internal_work_timing() {
    ...
    for field in [
        ...
        "guest_trace_main_report_fast_path_count",
        "guest_trace_main_report_generic_fallback_count",
        "guest_trace_main_report_fcall_result_fast_path_count",
        "guest_trace_main_report_load_copy_fast_path_count",
        "guest_trace_main_report_load_sign_extend_fast_path_count",
        "guest_trace_main_report_no_memory_fast_path_count",
        ...
        "guest_trace_runner_instruction_cache_fcall_clear_count",
        "guest_trace_runner_instruction_cache_dma_clear_count",
    ...
    for accessor in [
        ...
        "pub fn guest_trace_runner_instruction_cache_fcall_clear_count",
        "pub fn guest_trace_runner_instruction_cache_dma_clear_count",
    ...
    for line_name in [
        ...
        "\"guest_trace_runner_advance_generic_fallback_shape_top_1_pattern\"",
        "\"guest_trace_runner_advance_generic_fallback_shape_top_1_count\"",
        "\"guest_trace_runner_advance_generic_fallback_shape_top_2_pattern\"",
        "\"guest_trace_runner_advance_generic_fallback_shape_top_2_count\"",
        "\"guest_trace_runner_advance_generic_fallback_shape_top_3_pattern\"",
        "\"guest_trace_runner_advance_generic_fallback_shape_top_3_count\"",
        "\"guest_trace_runner_advance_generic_fallback_shape_top_4_pattern\"",
        "\"guest_trace_runner_advance_generic_fallback_shape_top_4_count\"",
    ...
    for cli_call in [
        ...
        "timing.guest_trace_main_report_generic_fallback_shape_top_patterns()",
        "timing.guest_trace_runner_advance_generic_fallback_shape_top_patterns()",
...
fn lean_top_level_soundness_exports_audited_global_local_contract() {
    ...
    assert!(
        lean_root_source.contains("import Lzvm.Soundness")
            ...
            && soundness_source.contains("accepted_proof_crypto_core_contract")
            && soundness_source.contains("accepted_proof_semantic_execution_obligations")
            && soundness_source
        ...
        "top-level Lean soundness should expose audited contracts with global soundness, verifier core, direct evidence, and execution obligations"
    );
}
