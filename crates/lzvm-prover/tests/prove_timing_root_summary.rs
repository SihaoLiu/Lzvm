...
fn prove_timing_root_summary_reports_root_grouping_shape() {
    ...
    for required in [
        ...
        "opening_row_value_words",
        "opening_row_value_bytes",
...
fn prove_timing_root_summary_reports_source_row_value_extend_priority() {
    ...
    let input = [
        ...
        "timing_finish_witness_opening_row_values_words=616",
        "timing_finish_witness_opening_row_values_bytes=4928",
    ...
    assert_eq!(value("opening_row_value_words"), "616");
    assert_eq!(value("opening_row_value_bytes"), "4928");
...
fn prove_timing_root_summary_aggregates_key_profile_means() {
    ...
    assert_eq!(
        aggregate_value("cuda_host_unregister_wait_ms_mean"),
        "500.000"
    );
    assert_eq!(
        aggregate_value("cuda_host_registration_total_wait_ms_mean"),
        "2500.000"
    );
