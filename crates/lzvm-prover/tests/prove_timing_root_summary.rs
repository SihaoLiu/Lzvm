...
fn prove_timing_root_summary_reports_retained_parent_checkpoint_opening_shape() {
    ...
    assert!(
        stdout.contains(
            ",43,0,0,0,0.000,0,0.000,none,120,119,1,0.833,77,77,yes,0,79,79,yes,0,0,79,3,0,0,790,14,869,17,11,858,device_batched_path_secondary,0,0,0,0,0,0,43,0,0,0,single_query_unit_boundary_blocks_row_value_batch,external_source_unit_boundary_blocks_row_value_batch,"
        ),
