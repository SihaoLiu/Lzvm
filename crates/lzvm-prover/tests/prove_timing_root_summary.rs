...
fn prove_timing_root_summary_reports_retained_parent_checkpoint_opening_shape() {
    ...
    assert!(
        stdout.contains(
            "opening_row_value_device_download_batches,opening_row_value_device_single_downloads,opening_batching_hint"
        ),
        "prove timing root summary should expose single-row device row-value downloads: stdout={stdout}"
    );
    assert!(
        stdout.contains(
            ",43,0,77,77,yes,0,79,79,yes,0,0,79,0,0,790,0,0,43,cross_query_unit_device_row_value_batching_candidate,"
        ),
...
fn prove_timing_root_summary_reports_opening_parent_hash_work_scope() {
    ...
    assert!(
        stdout.contains(
            "retained_parent_checkpoint_prefix_rows,retained_parent_checkpoint_prefix_bytes,retained_parent_checkpoint_prefix_launches,retained_parent_checkpoint_suffix_rows,retained_parent_checkpoint_suffix_bytes,retained_parent_checkpoint_suffix_launches,opening_path_parent_hash_launches_per_stage,opening_row_value_device_download_batches,opening_row_value_device_single_downloads"
        ),
