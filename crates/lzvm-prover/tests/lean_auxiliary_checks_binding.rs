...
fn lean_auxiliary_checks_binding_exports_core_contract_projections() {
    ...
    for (theorem, combined_helper, wraps_some, field_terms) in [
        ...
        (
            ...
            &[
                ...
                "cudaAllocatorDeviceSynchronizeWaitNanoseconds := deviceSynchronizeWaitNanoseconds",
                "cudaAllocatorDeviceSynchronizeMaxWaitNanoseconds := deviceSynchronizeMaxWaitNanoseconds",
                ...
                "cudaAllocatorEventSynchronizeMaxWaitNanoseconds := eventSynchronizeMaxWaitNanoseconds",
                ...
                "cudaAllocatorEventSynchronizeHotWaitNanoseconds := eventSynchronizeHotWaitNanoseconds",
    ...
    for (theorem, audited_helper, field_terms, wraps_some) in [
        ...
        (
            "cuda_allocator_aggregate_timing_acceptance_audited_core_contract",
            "cuda_allocator_timing_acceptance_audited_core_contract",
            &[
                "cudaAllocatorMallocCallCount := mallocCalls",
                "cudaAllocatorMallocByteCount := mallocBytes",
    ...
    for (theorem, field_terms) in [
        ...
        (
            ...
            &[
                ...
                "finishWitnessExternalSourceDescriptorUploadMilliseconds := descriptorUploadMilliseconds",
    ...
    let aggregate_finish_field_terms = [
        ...
        "finishWitnessOpeningRetainedLeafDigestOpeningCount := witnessOpeningRetainedLeafDigestOpeningCount",
        "finishWitnessOpeningRetainedLeafDigestOpeningRowCount := witnessOpeningRetainedLeafDigestOpeningRowCount",
        "finishWitnessOpeningRetainedParentCheckpointOpeningCount := witnessOpeningRetainedParentCheckpointOpeningCount",
        "finishWitnessOpeningRetainedParentCheckpointOpeningRowCount := witnessOpeningRetainedParentCheckpointOpeningRowCount",
        "finishWitnessOpeningRowDedupInputRowCount := witnessOpeningRowDedupInputRowCount",
        "finishWitnessOpeningRowDedupUniqueRowCount := witnessOpeningRowDedupUniqueRowCount",
        "finishWitnessOpeningRowDedupElidedRowCount := witnessOpeningRowDedupElidedRowCount",
    ...
    lean_binding::assert_theorem_declarations(
        &proof_timing_verifier_source,
        &[aggregate_finish_audited_theorem],
    );
    assert_audited_core_contract_prefix(
        &proof_timing_verifier_source,
        aggregate_finish_audited_theorem,
    ...
    let aggregate_audited_prefix = lean_binding::theorem_prefix(
        &proof_timing_verifier_source,
        aggregate_finish_audited_theorem,
    );
    for field_term in aggregate_finish_field_terms {
        assert!(
            compact_source_contains(&aggregate_audited_prefix, field_term),
            "Lean theorem {aggregate_finish_audited_theorem} prefix should wire field {field_term}"
        );
    }
    lean_binding::assert_theorem_body_contains(
        &proof_timing_verifier_source,
    ...
    lean_binding::assert_theorem_body_contains(
        &auxiliary_projected_source,
        "runtime_performance_observation_auxiliary_contract_evidence",
        &[
            "runtime_performance_observation_auxiliary_contracts",
    ...
    for (theorem, field_terms) in [
        ...
        (
            "guest_pc_trace_shape_counts_acceptance_audited_core_contract",
            &[
                "guestTraceSingleRowReportCount := singleRowReports",
                "guestTraceMultiRowReportCount := multiRowReports",
                "guestTracePendingDmaReportCount := pendingDmaReports",
        ...
        (
            "guest_pc_trace_memory_access_shape_acceptance_audited_core_contract",
            &[
                "guestTraceIndirectMemoryRowCount := indirectMemoryRows",
                "guestTraceMemorySourceReadCount := memorySourceReads",
                "guestTraceMemoryStoreRowCount := memoryStoreRows",
        ...
        (
            "guest_pc_trace_report_buffer_capacity_acceptance_audited_core_contract",
            &[
                "guestTraceReportBufferCapacity := capacity",
                "guestTraceReportBufferMaxCapacity := maxCapacity",
                "guestTraceReportBufferExcessCapacity := excessCapacity",
        ...
        (
            "guest_pc_trace_descriptor_upload_word_count_acceptance_audited_core_contract",
            &["guestDeviceSourceDescriptorUploadWordCount := wordCount"][..],
        ),
        (
            "guest_pc_trace_descriptor_upload_shape_acceptance_audited_core_contract",
            &[
                "guestDeviceSourceDescriptorUploadByteCount := byteCount",
                "guestDeviceSourceDescriptorUploadWordCount := wordCount",
                "guestDeviceSourceDescriptorUploadRowCount := rowCount",
        ...
        (
            "guest_pc_trace_leaf_work_timing_acceptance_audited_core_contract",
            &[
                "guestStageLeafUploadWorkMilliseconds := uploadMilliseconds",
                "guestStageLeafKernelWorkMilliseconds := kernelMilliseconds",
                "guestStageLeafDownloadWorkMilliseconds := downloadMilliseconds",
        ...
        (
            "guest_pc_trace_leaf_coset_timing_acceptance_audited_core_contract",
            &[
                "guestStageLeafCosetExtendCallCount := callCount",
                "guestStageLeafCosetExtendOutputByteCount := outputByteCount",
                "guestStageLeafCosetExtendColumnCount := columnCount",
        ...
        (
            "guest_pc_trace_tree_commit_timing_acceptance_audited_core_contract",
            &[
                "guestStageTreeCommitWorkMilliseconds := workMilliseconds",
                "guestStageTreeCommitCheckpointWorkMilliseconds := checkpointMilliseconds",
                "guestStageTreeCommitRootWorkMilliseconds := rootMilliseconds",
    ...
    assert!(
        lean_source.contains("GuestPcTraceParallelLowerConfig")
            && lean_source.contains("configuredParallelLower")
            && lean_source.contains("configuredWorkUnits")
            && lean_source.contains("configuredReplayOnly")
            && lean_source.contains("configuredReplaySnapshot")
            && lean_source.contains("effectiveParallelLower")
            && lean_source.contains("effectiveReplayOnly")
            && lean_source.contains("effectiveReplaySnapshot")
            && lean_source.contains("GuestPcTraceParallelLowerDecisionMatches")
            && lean_source.contains("parallelLowerConfigAccepted")
            && lean_source.contains("parallelLowerConfigImpliesDecisionMatches")
            && lean_source.contains("GuestPcTraceParallelLowerCheckedAcceptance")
            && guest_backend_source.contains("fn guest_pc_trace_parallel_lower_enabled")
            && guest_backend_source.contains("fn guest_pc_trace_parallel_lower_work_units_enabled")
            && guest_backend_source.contains("fn guest_pc_trace_parallel_lower_report_elision_enabled")
            && guest_backend_source.contains("fn guest_pc_trace_parallel_lower_replay_snapshot_enabled"),
        "Lean auxiliary checks should bind guest trace parallel lower selector decisions to the Rust runtime knobs"
    );
    assert!(
    ...
    assert!(
        lean_source.contains("GuestPcTraceSegmentCommitModeConfig")
            ...
            && gpu_runtime_source
                .contains("guest_pc_trace_parallel_lower_replay_only_selects_replay_only")
            && gpu_runtime_source
                .contains("guest_pc_trace_parallel_lower_replay_only_selects_replay_snapshot")
            && gpu_runtime_source
                .contains("guest_pc_trace_parallel_lower_replay_snapshot_selects_replay_snapshot")
            && gpu_runtime_source.contains(
    ...
    assert!(
        lean_source.contains("GpuRetainedDeviceCacheBudget")
            ...
            && lean_source
                .contains("gpu_retained_device_cache_budget_checked_limits_core_and_sound")
            && lean_source.contains(
                "gpu_retained_device_cache_budget_checked_combined_limit_core_and_sound",
            )
            && lean_source.contains(
                "gpu_retained_device_cache_budget_checked_parent_checkpoint_headroom_core_and_sound",
            )
            && lean_source.contains(
                "gpu_retained_device_cache_budget_checked_limits_audited_core_contract",
            )
            && lean_source.contains(
                "gpu_retained_device_cache_budget_checked_combined_limit_audited_core_contract",
            )
            && lean_source.contains(
                "gpu_retained_device_cache_budget_checked_parent_checkpoint_headroom_audited_core_contract",
            )
            ...
            && witness_values_source.contains("parent_reserved_bytes")
            && witness_values_source
                .contains("retained_parent_checkpoint_limit().saturating_sub(parent_bytes)"),
        "Lean auxiliary checks should bind retained source, descriptor, leaf digest, and parent checkpoint cache retention to runtime budget limits and leaf headroom"
    );
    assert!(
    ...
    for field in [
        ...
        "sourceExtendCallCount",
        "sourceExtendMaxRowCount",
    ...
    lean_binding::assert_theorem_declarations(
        ...
        &[
            ...
            "gpu_canonical_leaf_checked_acceptance_leaf_bytes_audited_core_contract",
            "gpu_leaf_output_buffer_reuse_checked_acceptance_leaf_bytes_audited_core_contract",
            "gpu_coset_extension_checked_acceptance_leaf_bytes_audited_core_contract",
            "gpu_fri_fold_interpolation_checked_acceptance_fri_folds_audited_core_contract",
    ...
    lean_binding::assert_theorem_prefix_contains(
        ...
        &[
            ...
            "config.gpuBackendAvailable = false",
            "GuestPcTraceLargeGpuGateCheckedAcceptance",
    ...
    lean_binding::assert_theorem_prefix_contains(
        ...
        &[
            "config.requestedInstructionLimit = some limit",
            "config.defaultLargeTraceInstructionThreshold <= limit",
            "GuestPcTraceLargeGpuGateMemoryCheckPasses config = false",
            "GuestPcTraceLargeGpuGateCheckedAcceptance",
            "config.largeTraceAllowed = false",
        ],
    );
    ...
    lean_binding::assert_theorem_prefix_contains(
        ...
        &[
            ...
            "exists freeBytes",
            "config.observedFreeGpuMemoryBytes = some freeBytes",
            "config.defaultMinFreeGpuMemoryBytes <= freeBytes",
        ],
    );
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
    ...
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_explicit_selects_parallel_lower",
        &["parallelLowerEnabled", "parallelMatches"],
    );
    lean_binding::assert_theorem_prefix_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_work_units_selects_parallel_lower",
    ...
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_work_units_selects_parallel_lower",
        &["workUnitsEnabled", "parallelMatches"],
    );
    lean_binding::assert_theorem_prefix_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_replay_only_selects_replay_only",
        &[
            ...
            "GuestPcTraceParallelLowerDecisionMatches config",
            "config.effectiveReplayOnly = true",
        ],
    );
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_replay_only_selects_replay_only",
        &["replayOnlyEnabled", "replayOnlyMatches"],
    );
    lean_binding::assert_theorem_prefix_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_replay_only_selects_replay_snapshot",
        &[
            "config.configuredReplayOnly = true",
            "GuestPcTraceParallelLowerDecisionMatches config",
            "config.effectiveReplaySnapshot = true",
        ],
    );
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_replay_only_selects_replay_snapshot",
        &["replayOnlyEnabled", "replaySnapshotMatches"],
    );
    lean_binding::assert_theorem_prefix_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_replay_snapshot_selects_replay_snapshot",
    ...
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_replay_snapshot_selects_replay_snapshot",
        &["replaySnapshotEnabled", "replaySnapshotMatches"],
    );
    lean_binding::assert_theorem_prefix_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_work_units_keeps_replay_only_separate",
    ...
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_work_units_keeps_replay_only_separate",
        &["replayOnlyDisabled", "replayOnlyMatches"],
    );
    lean_binding::assert_theorem_prefix_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_work_units_keeps_replay_snapshot_separate",
    ...
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_checked_acceptance_projects_decision",
        &["parallelLowerConfigImpliesDecisionMatches", "checked.right"],
    );
    lean_binding::assert_theorem_body_contains(
        &gpu_runtime_source,
        "guest_pc_trace_parallel_lower_checked_acceptance_verifier_core_contract",
    ...
    let retained_parent_headroom_budget_terms = [
        "budget.sourceBytes",
        "+ budget.descriptorBytes",
        "+ budget.leafDigestBytes",
    ...
    lean_binding::assert_theorem_prefix_contains(
        ...
        "gpu_retained_device_cache_budget_checked_parent_checkpoint_headroom_implies_combined_limit",
        &[
            &retained_parent_headroom_budget_terms[..],
            &retained_combined_budget_terms[..],
        ]
        .concat(),
    );
