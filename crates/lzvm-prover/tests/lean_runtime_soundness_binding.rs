...
fn lean_runtime_soundness_binding_exports_core_contract_projection() {
    ...
    let runtime_soundness_audited_core_path =
        crate_root.join("../../lean/Lzvm/RuntimeSoundness/AuditedCore.lean");
    let runtime_soundness_audited_core_source =
        std::fs::read_to_string(&runtime_soundness_audited_core_path)
            .expect("Lean runtime soundness audited-core source should read");
    ...
    lean_binding::assert_theorem_declarations(
        ...
        &[
            ...
            "runtime_soundness_required_external_source_accepts_evidence_core_and_sound",
    ...
    lean_binding::assert_theorem_prefix_omits(
        &lean_source,
        "runtime_soundness_checked_acceptance_audited_core_sound_witness_contract",
        &["RuntimeProofArtifactFinalized", "RuntimeSoundnessEvidence"],
    );
    lean_binding::assert_theorem_body_contains(
        &lean_source,
        "runtime_soundness_checked_acceptance_audited_core_sound_witness_contract",
    ...
    assert!(
        ...
        .contains("RuntimeSoundnessEvidence"),
        "compact required external-source audited soundness PCS/FRI core contract should not force callers to unpack full runtime evidence"
    );
    lean_binding::assert_theorem_prefix_contains(
        &lean_source,
        "runtime_soundness_required_external_source_audited_finalized_core_sound_witness_contract",
