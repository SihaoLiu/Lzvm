...
fn proof_timing_batch_runs_commands_and_appends_stable_log() {
    ...
    let output = Command::new(&script_path)
        ...
        .arg(concat!(
            ...
            "timing_finish_witness_opening_row_values_ms=0\\n",
            "timing_finish_witness_opening_row_value_source_extend_ms=0\\n",
            "timing_finish_witness_opening_row_value_source_download_ms=0\\n",
            "timing_finish_witness_opening_row_value_device_download_ms=0\\n",
            "timing_finish_witness_opening_row_values_device_rows=0\\n",
            ...
            "timing_finish_witness_opening_row_value_source_extend_calls=0\\n",
            "timing_finish_witness_opening_row_value_source_extend_max_rows=0\\n",
            "timing_finish_witness_opening_row_values_source_rows=0\\n",
            "timing_finish_witness_opening_row_values_words=0\\n",
            "timing_finish_witness_opening_row_values_bytes=0\\n",
