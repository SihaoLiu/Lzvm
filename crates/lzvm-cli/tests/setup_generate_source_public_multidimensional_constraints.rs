...
fn temp_dir(name: &str) -> PathBuf {
    std::env::temp_dir().join(format!(
        "lzvm-cli-setup-generate-source-public-multidimensional-constraints-{}-{name}",
        std::process::id()
    ))
}
...
#[test]
fn generate_key_indexes_multidimensional_public_array_source_constraints() {
    let dir = temp_dir("public-multidimensional-array-constraint");
