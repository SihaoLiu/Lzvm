...
#[test]
fn generate_key_lowers_source_function_static_while_global_constraints() {
    let dir = temp_dir("source-function-static-while");
    let _ = fs::remove_dir_all(&dir);
    let source_path = dir.join("source").join("main.pil");
    write_file(
        &source_path,
...
#[test]
fn generate_key_lowers_source_function_static_do_while_global_constraints() {
    let dir = temp_dir("source-function-static-do-while");
    let _ = fs::remove_dir_all(&dir);
    let source_path = dir.join("source").join("main.pil");
    write_file(
        &source_path,
