...
mod public_input_fixture;

use public_input_fixture::sample_public_block_bytes_with_matching_roots;
...
fn proof_artifact_timing_reports_parent_hash_shape_counts() {
    let timing = lzvm_prover::WitnessProofArtifactTiming {
        ...
        witness_opening_retained_leaf_digest_opening_count: 32,
    ...
    assert!(stdout
        .contains("timing_finish_witness_opening_retained_leaf_digest_opening_extra_rows=0\n"));
    assert!(stdout.contains(
        "timing_finish_witness_opening_retained_leaf_digest_all_single_row_openings=1\n"
    ));
    assert!(stdout.contains(
        "timing_finish_witness_opening_retained_parent_checkpoint_opening_extra_rows=3\n"
    ));
    assert!(stdout.contains(
...
fn proof_artifact_timing_reports_per_stage_opening_work_shape() {
    let timing =
        lzvm_prover::WitnessProofArtifactTiming {
            ...
            witness_opening_row_values_device_single_download_count: 11,
            witness_opening_row_values_source_extend_call_count: 13,
            witness_opening_row_values_source_extend_max_row_count: 17,
            ...
            witness_stage_opening_work: vec![lzvm_prover::WitnessProofStageOpeningWork {
                ...
                row_values_device_single_download_count: 12,
                row_values_source_extend_call_count: 13,
                row_values_source_extend_max_row_count: 17,
    ...
    for expected in [
        ...
        "timing_finish_witness_opening_row_values_device_single_downloads=11\n",
        "timing_finish_witness_opening_row_value_source_extend_calls=13\n",
        "timing_finish_witness_opening_row_value_source_extend_max_rows=17\n",
        ...
        "timing_finish_witness_stage_7_opening_retained_leaf_digest_opening_extra_rows=1\n",
        "timing_finish_witness_stage_7_opening_retained_leaf_digest_all_single_row_openings=0\n",
