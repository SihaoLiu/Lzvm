...
theorem gpu_canonical_leaf_checked_acceptance_leaf_bytes_core_and_sound
  ...
  have coreAndSound :=
    auxiliary_checked_acceptance_core_and_sound
      ...
      proof
      checked
  exact And.intro leafBytes coreAndSound
...
theorem gpu_fri_fold_interpolation_checked_acceptance_fri_folds_core_and_sound
  ...
  have coreAndSound :=
    auxiliary_checked_acceptance_core_and_sound
      ...
      proof
      checked
  exact And.intro foldsValid coreAndSound
...
theorem gpu_canonical_leaf_checked_acceptance_leaf_bytes_audited_core_contract
  ...
  exact
    And.intro audited.left
      (And.intro audited.right.left
        (And.intro leafBytes audited.right.right))
...
theorem gpu_fri_fold_interpolation_checked_acceptance_fri_folds_audited_core_contract
  ...
  exact
    And.intro audited.left
      (And.intro audited.right.left
        (And.intro friFolds audited.right.right))
